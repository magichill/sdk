 ...
 */
public class ContributeRankResponse {
    ...
    public void parseFromUserList(List<ContributeUserRank> users){
    ...
    public void buildUserProfileResponse(List<ContributeUserRank> users,List<UserProfileResponse> responses) {
        for (ContributeUserRank user : users) {
            ...
            userProfileResponse.setMoney(user.getMoney());
